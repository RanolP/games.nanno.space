...
const games = [
  {
    name: "Cosmic Puzzle",
    emoji: "🚀",
    description: "Navigate through space puzzles",
  ...
  },
  {
    name: "Number Quest",
    emoji: "🔢",
    description: "Mathematical adventures await",
      ...
      <div className="max-w-4xl mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600">
            Let fate decide your next gaming adventure!
          </p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden mb-8">
          <div
            className={`aspect-video bg-gradient-to-br ${currentGame.color} flex items-center justify-center relative overflow-hidden`}
          >
            <div
              className={`text-8xl ${isSpinning ? "animate-bounce" : "animate-pulse"}`}
            >
              {currentGame.emoji}
            </div>
            {isSpinning && (
          ...
          <div className="p-8">
            ...
            <div className="flex gap-4">
              <button className="flex-1 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg font-semibold hover:from-purple-700 hover:to-pink-700 transition shadow-lg">
                Play Now
              </button>
              <button
